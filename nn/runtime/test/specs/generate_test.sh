...
[ -z "$TEST_DIR" ] && TEST_DIR="frameworks/ml/nn/runtime/test"
...
function generate_one_testcase {
  ...
  local EXAMPLE="-e $NNAPI_BASE/runtime/test/generated/examples/$BASENAME.example.cpp"

  $NNAPI_BASE/tools/test_generator/test_generator.py ./`basename $1`\
    -m $NNAPI_BASE/runtime/test/generated/models/$BASENAME.model.cpp $EXAMPLE
  ret=$?
...
function generate_wrapper {
  ...
  OUTFILE=$NNAPI_BASE/runtime/test/generated/all_generated_tests.cpp
