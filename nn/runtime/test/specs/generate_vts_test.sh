...
function generate_one_testcase {
  ...
  ../../../tools/test_generator/vts_generator.py ./`basename $1`\
...
echo "// forward declare" >> $OUTFILE
echo "hidl_memory allocateSharedMemory(int64_t size, const std::string& type = \"ashmem\");" \
  >> $OUTFILE
